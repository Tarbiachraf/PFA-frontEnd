...
const Service = () => {
   return( <div className="popular-categories">
                         ...
                         <div className="row">
                           <div className="col-lg-5 align-self-center">
                             <div className="left-text">
                               ...
                               <div className="main-white-button"><a href="#"><i class="fa fa-eye"></i> Discover More</a></div>
                             </div>
                           </div>
                         ...
                         <div className="row">
                           <div className="col-lg-5 align-self-center">
                             <div className="left-text">
                               ...
                               <div className="main-white-button"><a href="#"><i class="fa fa-eye"></i> Explore More</a></div>
                             </div>
                           </div>
                           <div className="col-lg-7 align-self-center">
                             <div className="right-image">
