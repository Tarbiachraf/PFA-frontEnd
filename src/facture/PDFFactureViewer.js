    ...
    <div style={{
      ...
      <div style={{        
       ...
       // padding: '20px', // Un peu d'espace autour du contenu PDF
        ...
        <FontAwesomeIcon icon={faPrint} onClick={handlePrint} style={{ cursor: 'pointer', position:'absolute',top: '0', right: '90px', color: 'white', fontSize: '34px', marginRight: '15px'}} />
        <FontAwesomeIcon icon={faTimes} onClick={() => setShowPDF(false)} style={{ cursor: 'pointer', position:'absolute',top: '0', right: '40px', color: 'white', fontSize: '34px', marginRight: '15px'}}/>
      </div>
    </div>
  );
};
