...
const UpdateUser = () => {
    ...
    const { id, firstname, lastname, email, phoneNumber, address, password, roleName } = state || {};
    ...
    const [user, setUser] = useState({
        ...
        address: address,
        password: password,
        roleName: roleName, // assuming you want to store role ID
    });
    ...
    useEffect(() => {
        ...
        const handleSubmit = (e) => {
            e.preventDefault();
            AppUserService.UpdateUser(user,user.id)
                .then(response => {
      ...
      const alertOfSucces = () => {
        return (
          <div className="alert alert-success  alert-dismissible fade show" role="alert" style={{ width: '100%', fontFamily: ' Arial, sans-serif', textAlign: 'center' }}>
            <span >l'utilisateur est modifié avec succés </span>
      ...
      const alertOfError = () => {
        return (
          <div className="alert alert-danger alert-dismissible fade show" role="alert" style={{ width: '100%', fontFamily: ' Arial, sans-serif', textAlign: 'center' }}>
            <span >error dans la modification d'utilisateur </span>
            <button type="button" className="close" data-dismiss="alert" aria-label="Close" onClick={closeAlert}>
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
            ...
            <div className="card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <select className="form-control" name="roleId" id="role" value={user.roleName} onChange={handleChange}>
