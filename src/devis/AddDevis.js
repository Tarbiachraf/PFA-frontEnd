    ...
    <div className='container mt-2 list-client Myfont' style={{ width: '100%' }}>
      <div className='card' style={{ width: '100%', maxHeight: 'calc(100vh - 100px)' }}>
        <div class="card-header cardHeader text-white">
          <h4>Veuillez choisir un client : <span className='text text-warning  text-md' style={{ fontFamily: 'Arial', }}> Si le devis concerne un nouveau client, vous devez le créer d'abord</span></h4>
        </div>
